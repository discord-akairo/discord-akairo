declare module 'discord-akairo' {
    ...
    export const Constants: {
        ...
        ArgumentTypes: Record<
            ...
            'NUMBER' | 'INTEGER' | 'BIGINT' | 'EMOJINT' |
            'URL' | 'DATE' | 'COLOR' | 'USER' |
            'USERS' | 'MEMBER' | 'MEMBERS' | 'RELEVANT' | 'RELEVANTS' |
            'CHANNEL' | 'CHANNELS' | 'TEXT_CHANNEL' | 'TEXT_CHANNELS' |
            'VOICE_CHANNEL' | 'VOICE_CHANNELS' | 'CATEGORY_CHANNEL' | 'CATEGORY_CHANNELS' |
            'NEWS_CHANNEL' | 'NEWS_CHANNELS' | 'STORE_CHANNEL' | 'STORE_CHANNELS' |
            'ROLE' | 'ROLES' | 'EMOJI' | 'EMOJIS' | 'GUILD' | 'GUILDS' |
            'MESSAGE' | 'GUILD_MESSAGE' | 'RELEVANT_MESSAGE' | 'INVITE' |
            'MEMBER_MENTION' | 'CHANNEL_MENTION' | 'ROLE_MENTION' | 'EMOJI_MENTION' |
            'COMMAND_ALIAS' | 'COMMAND' | 'INHIBITOR' | 'LISTENER', string
        >;
        AkairoHandlerEvents: Record<'LOAD' | 'REMOVE', string>;
        CommandHandlerEvents: Record<
            'MESSAGE_BLOCKED' | 'MESSAGE_INVALID' |
